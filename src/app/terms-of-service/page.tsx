      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600">
              To request a refund, email <a href="mailto:hello@govconedu.com" className="text-blue-800 hover:underline">hello@govconedu.com</a> with your order details.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600">
              ...
              <a href="mailto:hello@govconedu.com" className="text-blue-800 hover:underline">
                hello@govconedu.com
              </a>
            </p>
          </section>
