        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 transition-all hover:-translate-y-1 hover:shadow-lg hover:border-blue-500">
              ...
              <a href="https://giants.lemonsqueezy.com/checkout/buy/9a5bd252-b7a5-4bc5-be50-1d3305dd9069" target="_blank" rel="noopener noreferrer" className="block w-full py-3 bg-blue-800 text-white text-center rounded-lg font-semibold hover:bg-blue-700 transition-all">
                Get Starter Bundle
              </a>
            </div>
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl border-2 border-amber-500 p-6 relative transition-all hover:-translate-y-1 hover:shadow-xl">
              ...
              <a href="https://giants.lemonsqueezy.com/checkout/buy/9a5bd252-b7a5-4bc5-be50-1d3305dd9069" target="_blank" rel="noopener noreferrer" className="block w-full py-3 bg-amber-500 text-white text-center rounded-lg font-semibold hover:bg-amber-400 transition-all">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl border border-gray-700 p-6 text-white transition-all hover:-translate-y-1 hover:shadow-xl">
              ...
              <a href="https://giants.lemonsqueezy.com/checkout/buy/67349828-9e8a-4e1a-bf6f-09b267c4c97e" target="_blank" rel="noopener noreferrer" className="block w-full py-3 bg-gradient-to-r from-amber-400 to-amber-500 text-gray-900 text-center rounded-lg font-bold hover:from-amber-300 hover:to-amber-400 transition-all">
                Get Ultimate Giant
              </a>
            </div>
          </div>
