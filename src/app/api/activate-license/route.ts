...
const ACCESS_FLAG_TO_TOOL: Record<string, ToolInfo> = {
  ...
  access_assassin_standard: { name: 'Federal Market Assassin', url: `${TOOLS_BASE}/federal-market-assassin`, key: 'access_assassin_standard' },
  access_assassin_premium: { name: 'Federal Market Assassin (Premium)', url: `${TOOLS_BASE}/federal-market-assassin`, key: 'access_assassin_premium' },
