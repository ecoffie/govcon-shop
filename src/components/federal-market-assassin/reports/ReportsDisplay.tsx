...
<body>
  ...
  <div style="background: linear-gradient(135deg, #fef3c7 0%, #fed7aa 100%); border: 2px solid #f59e0b; border-radius: 12px; padding: 30px; text-align: center; margin-top: 40px;">
    ...
    <p style="color: #78350f; font-weight: bold;">Visit mi.govcongiants.com to upgrade to Premium</p>
  </div>
  `}
  ...
  <div style="text-align: center; margin-top: 30px;">
    ...
    <p style="color: #94a3b8; font-size: 11px;">
      © ${new Date().getFullYear()} GovCon Giants. All rights reserved. | govcongiants.com
    </p>
  </div>
</body>
</html>`;
          ...
          <div className="space-y-12">
            ...
            {tier === 'standard' && (
              <div className="print:break-after-page bg-amber-500/10 border-2 border-amber-500/50 rounded-xl p-8 text-center">
                ...
                <p className="text-amber-400 font-bold">Visit mi.govcongiants.com to upgrade</p>
              </div>
            )}
          </div>
        ) : (
